...
- Вам предоставлены статьи для разработки и отладки вашего агента:
  1. [Статья #1](https://disk.yandex.ru/d/5QUSTtqBWjps3A)
  2. [Статья #2](https://disk.yandex.ru/d/YJSJ-rGv4a0TzQ)
...
- Максимальное время работы агента **30 минут**.

Лимит сабмитов распространяется только на успешные попытки. 
